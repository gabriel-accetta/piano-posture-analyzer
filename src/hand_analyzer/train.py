...
def plot_training_charts(model, X_test, y_test, y_pred, accuracy):
    ...
    ax.set_title('Confusion Matrix - Hand Posture Classifier')
    plt.tight_layout()
    ...
    ax.set_title('Top 15 Most Important Features - Hand Posture')
    plt.tight_layout()
    ...
    summary_text = f"""
    MODEL PERFORMANCE SUMMARY - HAND POSTURE CLASSIFIER
